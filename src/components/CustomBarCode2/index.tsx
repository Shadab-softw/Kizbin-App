...
export default function CustomBarCode2(props: IProps) {
  ...
  const barcodeValue = barcode ? barcode : t("common:SEARCH_BARCODE");
  ...
  return (
    <>
      <ScreensButton
        ...
        btnTitle={t("common:SEARCH_BARCODE")}
        iconName=""
              ...
              <View style={styles.cameraContainer}>
                ...
                {isFocused ? (
                  <RNCamera
                    ...
                    // googleVisionBarcodeType={RNCamera.Constants.GoogleVisionBarcodeDetection.BarcodeMode.INVERTED} 
                    ref={(ref) => { camera = ref }}
                    // ref={cameraRef}
